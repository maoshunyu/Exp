...
public:
  teacher(const char name[11], const char number[7], const char sex[3],
          const char id[16], int y, int m, int d, const char ps[11],
          const char de[21])
      : People(name, number, sex, id, y, m, d) {
  ...
  inline void show() {
    People::show();
    cout << "principalship: " << principalship << "  "
...
public:
  student(const char name[11], const char number[7], const char sex[3],
          const char id[16], int y, int m, int d, const char cn[7])
      : People(name, number, sex, id, y, m, d) {
...
public:
  graduate(const char name[11], const char number[7], const char sex[3],
           const char id[16], int y, int m, int d, const char cn[7],
           const char su[21], const char te[30])
      : People(name, number, sex, id, y, m, d),
        student(name, number, sex, id, y, m, d, cn) {
...
public:
  TA(const char name[11], const char number[7], const char sex[3],
     const char id[16], int y, int m, int d, const char cn[7],
     const char su[21], const char te[30], const char ps[11], const char de[21])
      : People(name, number, sex, id, y, m, d),
        teacher(name, number, sex, id, y, m, d, ps, de),
        graduate(name, number, sex, id, y, m, d, cn, su, te) {
...
int main() {
  TA ta("alice", "1", "wo", "12345678", 2003, 1, 1, "123456", "electronic",
        "yang fang", "ta", "department of ee");
  ta.show();
}
